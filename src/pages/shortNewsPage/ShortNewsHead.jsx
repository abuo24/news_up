...
import shortNewsHead from "../home/shortNews/shortNewsHead";
import {allShortPosts} from "../../redux/actions/shortPostApi";
import {BrowserRouter, NavLink, Route, Switch} from "react-router-dom";
import {Layout} from "../../hoc";
import {About, AllVideos, BlogDetail, Contact, Home, News, NewsHead, ShortNewsPage} from "../index";
                    ...
                    <div className="row">
                        <div className="col-12 col-sm-12 col-md-2">
                            <div className={"categories"}><NavLink
                                to={`/shortnews`} activeClassName={"active_categories"}>{this.props.langReducer.lang.latest}</NavLink>
                            </div>
